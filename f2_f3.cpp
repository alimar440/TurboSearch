...
void f2_f3::comparaison_f2_f3()
{

    table_hachage table_f2,table_f3;
    table_f2.setHachage_actuelle(2);
    table_f3.setHachage_actuelle(3);
    ...
    while(query.next() && i<500)
    {
        ...
        table_f3.inserer(query.value(0).toString(),V);
    ...
    while(query.next() && i<500)
    {
        ...
        table_f3.get(query.value(0).toString());
    ...
    customPlot->yAxis->setRange(0, 8000);
